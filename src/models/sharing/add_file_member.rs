...
type Request<'a> = AddFileMemberRequest<'a>;
type Response = AddFileMemberResponse;
type RequestPayload = super::AddFileMemberArgs;
...
#[derive(Debug)]
pub struct AddFileMemberRequest<'a> {
...
#[allow(dead_code)]
pub struct AddFileMemberResponse {
