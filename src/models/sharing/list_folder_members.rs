...
type Request<'a> = ListFolderMembersRequest<'a>;
type Response = ListFolderMembersResponse;
type RequestPayload = super::ListFolderMembersArgs;
...
#[derive(Debug)]
pub struct ListFolderMembersRequest<'a> {
