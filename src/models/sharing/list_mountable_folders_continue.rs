...
type Request<'a> = ListMountableFoldersContinueRequest<'a>;
type Response = ListMountableFoldersContinueResponse;
...
#[derive(Debug)]
pub struct ListMountableFoldersContinueRequest<'a> {
...
#[allow(dead_code)]
pub struct ListMountableFoldersContinueResponse {
