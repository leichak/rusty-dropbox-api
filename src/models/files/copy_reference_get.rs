use super::{GetCopyReferenceArgs as Args, GetCopyReferenceResult as RequestResult};
...
type Request<'a> = CopyReferenceGetRequest<'a>;
type Response = CopyReferenceGetResponse;
...
#[derive(Debug)]
pub struct CopyReferenceGetRequest<'a> {
...
#[allow(dead_code)]
pub struct CopyReferenceGetResponse {
