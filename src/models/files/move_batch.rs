use super::{MoveBatchArgs as Args, RelocationBatchV2Launch as RequestResult};
...
type Request<'a> = MoveBatchRequest<'a>;
type Response = MoveBatchResponse;
