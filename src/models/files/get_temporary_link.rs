use super::{GetTemporaryLinkArgs as Args, GetTemporaryLinkResult as RequestResult};
...
type Request<'a> = GetTemporaryLinkRequest<'a>;
...
#[derive(Debug)]
pub struct GetTemporaryLinkRequest<'a> {
