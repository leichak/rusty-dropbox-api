use super::PermanentlyDeleteArgs as Args;
...
type Request<'a> = PermanentlyDeleteRequest<'a>;
type Response = PermanentlyDeleteResponse;
...
#[derive(Debug)]
pub struct PermanentlyDeleteRequest<'a> {
...
#[allow(dead_code)]
pub struct PermanentlyDeleteResponse {
