use super::{ListFolderLongpollArgs as Args, ListFolderLongpollResult as RequestResult};
...
type Request<'a> = ListFolderLongpollRequest<'a>;
type Response = ListFolderLongpollResponse;
...
#[derive(Debug)]
pub struct ListFolderLongpollRequest<'a> {
...
#[allow(dead_code)]
pub struct ListFolderLongpollResponse {
