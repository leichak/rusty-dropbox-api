use super::{AsyncJobCheckArgs as Args, SaveUrlJobStatus as RequestResult};
...
type Request<'a> = SaveUrlCheckJobStatusRequest<'a>;
type Response = SaveUrlCheckJobStatusResponse;
...
#[allow(dead_code)]
pub struct SaveUrlCheckJobStatusResponse {
