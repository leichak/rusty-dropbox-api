...
type Request<'a> = CreateFolderBatchCheckRequest<'a>;
type Response = CreateFolderBatchCheckResponse;
...
#[derive(Debug)]
pub struct CreateFolderBatchCheckRequest<'a> {
...
#[allow(dead_code)]
pub struct CreateFolderBatchCheckResponse {
