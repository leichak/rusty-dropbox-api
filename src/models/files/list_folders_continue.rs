use super::{ListFolderContinueArgs as Args, ListFolderContinueResult as RequestResult};
...
type Request<'a> = ListFolderContinueRequest<'a>;
type Response = ListFolderContinueResponse;
...
#[derive(Debug)]
pub struct ListFolderContinueRequest<'a> {
...
#[allow(dead_code)]
pub struct ListFolderContinueResponse {
