use super::{DeleteBatchArgs as Args, DeleteBatchResult as RequestResult};
...
type Request<'a> = DeleteBatchRequest<'a>;
type Response = DeleteBatchResponse;
...
#[derive(Debug)]
pub struct DeleteBatchRequest<'a> {
