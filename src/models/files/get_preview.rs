use super::{GetPreviewArg as Args, GetPreviewResult as RequestResult};
...
type Request<'a> = GetPreviewRequest<'a>;
type Response = GetPreviewResponse;
...
#[derive(Debug)]
pub struct GetPreviewRequest<'a> {
