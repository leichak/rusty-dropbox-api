use super::{CopyBatchArgs as Args, RelocationBatchV2Result as RequestResult};
...
type Request<'a> = CopyBatchRequest<'a>;
type Response = CopyBatchResponse;
