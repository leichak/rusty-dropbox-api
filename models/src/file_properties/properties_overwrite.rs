...
// Impl utils trait
implement_utils!(PropertiesOverwriteRequest<'_>, PathWithPropertyGroups);

// Impl service trait
implement_service!(
    PropertiesOverwriteRequest<'_>,
    PropertiesOverwriteResponse,
...
mod tests {
    ...
    use super::{PathWithPropertyGroups, PropertiesOverwriteRequest};
